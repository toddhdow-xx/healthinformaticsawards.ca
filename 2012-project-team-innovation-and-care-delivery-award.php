<? 
$page_title = "2012 Project Team - Innovation and Care Delivery Award"; 
...
<tr bgcolor="#866B3E">
<td class="c"><font color="#FFFFFF">&nbsp;&nbsp;Project Team - Innovation and Care Delivery Award</font></td>
</tr>
<tr>
<td class="b" colspan="2">
<div style="padding: 0px 10px 0px 10px;">
<p>
This award recognizes a for-profit healthcare ICT company and client team that has successfully implemented a new, innovative health-IT solution at a healthcare organization. This award honours the private and public sector team effort. The successful project team will demonstrate the achievement of stated objectives and provide a success story from which other organizations can learn. The award receipt will have fully implemented a health-IT solution within the past 12 months.<BR>
<BR>
<a href="http://coach.survey.esolutionsgroup.ca/TakeSurvey.aspx?SurveyID=llKK764">SUBMIT NOW</a><BR>
<BR>
<B>KEY CHARACTERISTICS</B> of public/private sector teams include the following:<BR>
<ul>
<li>Design and delivery of an innovative health information technology solution 
<li>Worked effectively together to implement an innovative solution 
...
<li>Resulted in adoption and utilization of the health-IT solution  
</ul>

<B>Criteria</B><BR>
The nominating organization is to assess the healthcare ICT company based on the following criteria; innovation teamwork, project objectives, and outcomes/results. A short specific description and/or example are to be provided for each sub-criteria statement. There is an area, after each criteria category, to provide highlighted overall details on how this project team has excelled in each category; this description is limited to <B>300 WORDS MAXIMUM.</B><BR>
<BR>
<B>Criteria 1: Innovation</B><BR>
The successful recipient will have demonstrated all of, but not limited to, the following:<BR>
1. Proof of new innovation, including but not limited to:<BR>
a) Description of how the technology solution works<BR>
b) Indication of why the solution is new and innovate, and how it relates to (i.e. extends or goes beyond) previous technological solutions<BR>
c) Reference to previous work (published or unpublished), trade magazine designs/articles, patents etc. to clearly prove claim for innovative nature of solution.<BR>
<BR>
...
d) Evaluated results once issues addressed.<BR>
<BR>
...
a) Delivered all objectives that MET OR EXCEEDED those outlined in contract b) Delivered quality work and high standards.<BR>
<BR>
...
<BR>
<B>Recognition:</B><BR>
The award will be presented at the <a href="http://www.healthinformaticsawards.ca/">Canadian Health Informatics Awards Gala</a> in Toronto Nov. 7, 2012.
